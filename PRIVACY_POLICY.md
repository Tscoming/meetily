# MeetVoice Privacy Policy

*Last updated: [Current Date]*

## Our Privacy-First Commitment

MeetVoice, 中文名会声记, is built on the principle that your meeting data should remain private and under your control. This privacy policy explains how we handle data in our open-source local AI meeting notes app.
...
### What We Collect
To improve MeetVoice and ensure optimal performance, we collect minimal, anonymized usage data:
...
*This privacy policy applies to MeetVoice v0.0.5 and later versions. For enterprise deployments, additional privacy controls may be available.*
