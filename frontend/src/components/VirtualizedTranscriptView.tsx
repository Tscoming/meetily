                    ...
                    {isRecording ? (
                        <>
                            ...
                            <p className="text-sm text-gray-600">
                                {isPaused ? t('transcript.recordingPaused') : t('transcript.listening')}
                            </p>
                            <p className="text-xs mt-1 text-gray-400">
                                {isPaused ? t('transcript.resumeHint') : t('transcript.speakHint')}
                            </p>
                        </>
                    ) : (
                        <>
                            <p className="text-lg font-semibold">{t('transcript.welcome')}</p>
                            <p className="text-xs mt-1">{t('transcript.startHint')}</p>
                        </>
                    )}
                </motion.div>
            ) : useVirtualization ? (
