    ...
    <>
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
          <div>
            <h4 className="font-semibold text-gray-800">{t('analytics.enableTitle')}</h4>
            <p className="text-sm text-gray-600">
              {isProcessing ? t('analytics.updating') : t('analytics.anonymousPatterns')}
            </p>
          </div>
          ...
          <div className="p-4 border rounded-lg bg-gray-50">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                <div className="font-medium text-gray-800 mb-1">{t('analytics.userIdTitle')}</div>
                <p className="text-xs text-gray-600 mb-2">
                  {t('analytics.userIdDescription')}
                </p>
                  ...
                  >
                    {isCopied ? (
                      <>
                        ...
                        <span className="text-green-600">{t('analytics.copied')}</span>
                      </>
                    ) : (
                      <>
