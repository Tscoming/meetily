...
export function About() {
    ...
    const handleCheckForUpdates = async () => {
        ...
        try {
            ...
            toast.error(`${t('about.updateCheckFailed')} ${error.message || t('common.unknownError')}`);
        } finally {
            setIsChecking(false);
        }
    };
    ...
    return (
        <div className="p-4 space-y-4 h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-3">
                <h2 className="text-base font-semibold text-gray-800">{t('about.differentTitle')}</h2>
                <div className="grid grid-cols-2 gap-2">
                    <div className="bg-gray-50 rounded p-3 hover:bg-gray-100 transition-colors">
                        <h3 className="font-bold text-sm text-gray-900 mb-1">{t('about.privacyFirstTitle')}</h3>
                        <p className="text-xs text-gray-600 leading-relaxed">{t('about.privacyFirstDescription')}</p>
                    </div>
                    <div className="bg-gray-50 rounded p-3 hover:bg-gray-100 transition-colors">
                        <h3 className="font-bold text-sm text-gray-900 mb-1">{t('about.anyModelTitle')}</h3>
                        <p className="text-xs text-gray-600 leading-relaxed">{t('about.anyModelDescription')}</p>
                    </div>
                    <div className="bg-gray-50 rounded p-3 hover:bg-gray-100 transition-colors">
                        <h3 className="font-bold text-sm text-gray-900 mb-1">{t('about.costSmartTitle')}</h3>
                        <p className="text-xs text-gray-600 leading-relaxed">{t('about.costSmartDescription')}</p>
                    </div>
                    <div className="bg-gray-50 rounded p-3 hover:bg-gray-100 transition-colors">
                        <h3 className="font-bold text-sm text-gray-900 mb-1">{t('about.worksEverywhereTitle')}</h3>
            ...
            <div className="bg-blue-50 rounded p-3">
                <p className="text-s text-blue-800">
                    <span className="font-bold">{t('about.comingSoonLabel')}</span> {t('about.comingSoonDescription')}
                </p>
            </div>
