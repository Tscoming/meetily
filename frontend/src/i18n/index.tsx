...
const translations: Record<UiLocale, Record<TranslationKey, string>> = {
  en: {
    ...
    'preferences.interfaceLanguage.description': 'Choose the display language used by Meetily.',
    ...
    'preferences.storage.description': 'View and access where Meetily stores your data',
    ...
    'about.title': 'About Meetily',
    'about.menuLabel': 'About',
    'about.tagline': 'Real-time notes and summaries that never leave your machine.',
    ...
    'about.differentTitle': 'What makes Meetily different',
    ...
    'analytics.description': 'Help us improve Meetily by sharing anonymous usage data. No personal content is collected-everything stays on your device.',
    ...
    'transcript.welcome': 'Welcome to Meetily!',
    ...
    'permission.microphoneMissing': 'Meetily needs access to your microphone to record meetings. No microphone devices were detected.',
    ...
    'permission.grantScreenRecording': 'Grant Screen Recording permission to Meetily',
  ...
  'zh-CN': {
    ...
    'preferences.interfaceLanguage.description': '选择 Meetily 界面显示语言。',
    ...
    'preferences.storage.description': '查看并打开 Meetily 存储数据的位置',
    ...
    'analytics.description': '分享匿名使用数据，帮助我们改进 Meetily。不会收集个人内容，所有内容都保留在你的设备上。',
    ...
    'transcript.welcome': '欢迎使用 Meetily！',
    ...
    'permission.microphoneMissing': 'Meetily 需要访问麦克风才能录制会议。未检测到麦克风设备。',
    ...
    'permission.grantScreenRecording': '授予 Meetily 屏幕录制权限',
